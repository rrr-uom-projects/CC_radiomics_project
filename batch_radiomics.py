'''
    script extracts radiomic features from images and masks listed in cases*.csv files
    results written in *_features.csv files
'''
...
def f_extractor(inpCSV, outFp):
    outPath = r'/home/chelmis/src'
    inputCSV = os.path.join(outPath, inpCSV)
    outputFilepath = os.path.join(outPath, outFp)
    ...
    if os.path.isfile(params):
        ...
        printt("Params.yaml file not found")
...
def main():
    f_extractor(cases_csv_file, radiomic_features_csv_files)
